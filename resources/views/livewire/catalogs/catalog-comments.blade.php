...
@foreach($comments as $comment)
    <div class="-my-10 py-10 flex items-center justify-between">
      ...
      <div>
        ...
        <button wire:click="showUpdateCatalogCommentModal('{{ $comment->id }}')" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-blue-500 text-base font-medium text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:ml-3 sm:w-auto sm:text-sm">
            Update
          </button>
