  ...
  <div class="max-w-max lg:max-w-7xl mx-auto">
    <div class="relative z-10 mb-8 md:mb-2 md:px-6">
      <div class="text-base max-w-prose lg:max-w-none">
        <h2 class="leading-6 text-indigo-900 font-semibold">About</h2>
        <p class="mt-2 text-3xl leading-8 font-bold tracking-tight text-blue-600 sm:text-4xl sm:tracking-tight">{{ $resource->title }}</p>
      </div>
    </div>
    <div class="relative">
