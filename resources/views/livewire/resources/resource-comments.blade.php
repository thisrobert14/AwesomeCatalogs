 <div class=" mt-14 px-2 py-1 rounded-xl ">
  <div>
    ...
    <div class="flex items-center justify-between bg-white  mb-4 px-2 rounded-xl">
      ...
      <div>
        ...
        <button wire:click="showUpdateResourceCommentModal('{{ $comment->id }}')" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-blue-400 text-white font-medium text-white hover:bg-blue-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:ml-3 sm:w-auto sm:text-sm">
          Update
        </button>
        <button wire:click="showDeleteResourceCommentModal('{{ $comment->id }}')" class="mt-3 w-full inline-flex justify-center rounded-md border shadow-sm px-4 py-2 bg-red-400 text-base font-medium text-white hover:bg-red-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
          Delete
        </button>
